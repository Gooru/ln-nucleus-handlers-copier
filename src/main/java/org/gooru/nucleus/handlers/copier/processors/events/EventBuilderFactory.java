...
public final class EventBuilderFactory {
    ...
    private static final String EVT_OA_COPY = "event.oa.copy";
    ...
    private static final String EVT_RUBRIC_COPY = "event.rubric.copy";
    ...
    public static EventBuilder getCopyOfflineActivityEventBuilder(String offlineActivityId) {
      return () -> new JsonObject().put(EVENT_NAME, EVT_OA_COPY).put(EVENT_BODY,
    ...
    public static EventBuilder getCopyRubricEventBuilder(String rubricId) {
        return () -> new JsonObject().put(EVENT_NAME, EVT_RUBRIC_COPY).put(EVENT_BODY,
