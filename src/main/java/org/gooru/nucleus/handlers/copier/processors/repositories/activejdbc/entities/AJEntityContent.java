...
public class AJEntityContent extends Model {
    ...
    public static final String COPY_ORIGINAL_RESOURCE_QUERY =
        "INSERT INTO content(id, tenant, tenant_root, title, url, creator_id, modifier_id, original_creator_id, "
            ...
            + " info, visible_on_profile, display_guide, accessibility, creator_system, primary_language) SELECT ?, ?::uuid, ?::uuid, "
            ...
            + "visible_on_profile, display_guide, accessibility, creator_system, primary_language FROM original_resource WHERE id = ? "
    ...
    public static final String COPY_REFERENCE_RESOURCE_QUERY =
        "INSERT INTO content(id, tenant, tenant_root, title, url, creator_id, modifier_id, original_creator_id, "
            ...
            + "content_subformat, metadata, taxonomy, thumbnail, is_copyright_owner, copyright_owner, info, "
            + "visible_on_profile, display_guide, accessibility, creator_system, primary_language FROM content WHERE id = ? AND "
            + "is_deleted=false";
    ...
    public static final String COPY_QUESTION_QUERY =
        "insert into content(id, tenant, tenant_root, title, url, creator_id, modifier_id, original_creator_id, "
            ...
            + "info, visible_on_profile, display_guide, accessibility, primary_language, max_score) select ?, ?::uuid, ?::uuid, title, url, ?, ?, "
            ...
            + "visible_on_profile, display_guide, accessibility, primary_language, max_score from content where id = ? and "
    ...
    public static final String COPY_RUBRIC_QUERY =
        ...
        + " thumbnail, tenant, tenant_root, increment, is_rubric, scoring, max_score, grader, primary_language) select gen_random_uuid() as id,"
        ...
        + " is_rubric, scoring, max_score, grader, primary_language FROM rubric where content_id = ?::uuid and is_deleted = false";
