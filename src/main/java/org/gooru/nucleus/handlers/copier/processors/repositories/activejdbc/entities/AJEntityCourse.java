...
public class AJEntityCourse extends Model {
    ...
    public static final String COPY_COURSE =
        "insert into course(id, tenant, tenant_root, title, description, owner_id, creator_id, modifier_id, "
            ...
            + "collaborator, sequence_id, subject_bucket, use_case) select ?, ?::uuid, ?::uuid, title, description, ?, ?, ?, "
            ...
            + ".subject_bucket = c.subject_bucket END) as sequence_id, subject_bucket, use_case from course c where "
