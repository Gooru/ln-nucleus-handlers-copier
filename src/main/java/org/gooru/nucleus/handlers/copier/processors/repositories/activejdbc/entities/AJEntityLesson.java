...
public class AJEntityLesson extends Model {
  ...
  public static final String COPY_LESSON =
      "insert into lesson(course_id, unit_id, lesson_id, title, owner_id, creator_id, modifier_id, original_creator_id, original_lesson_id, parent_lesson_id, metadata, taxonomy, sequence_id) select ?, ?, ?, l.title, ?, ?, ?, coalesce(l.original_creator_id, l.creator_id) as original_creator_id, coalesce(l.original_lesson_id, l.lesson_id) as original_lesson_id, l.lesson_id, l.metadata, l.taxonomy, l.sequence_id from lesson l where l.lesson_id = ?  and l.is_deleted = false";
