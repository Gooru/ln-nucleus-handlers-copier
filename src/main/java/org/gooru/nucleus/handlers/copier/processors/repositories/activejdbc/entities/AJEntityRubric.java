...
public class AJEntityRubric extends Model {
    ...
    public static final String COPY_RUBRIC =
        "INSERT INTO rubric(id, title, url, is_remote, description, categories, feedback_guidance, total_points, overall_feedback_required,"
        ...
        + " url, is_remote, description, categories, feedback_guidance, total_points, overall_feedback_required, ?::uuid, ?::uuid,"
