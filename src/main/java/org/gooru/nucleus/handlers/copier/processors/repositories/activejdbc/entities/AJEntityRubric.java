...
public class AJEntityRubric extends Model {
    ...
    public static final String COPY_RUBRIC =
        ...
        + " gut_codes, thumbnail, created_at, updated_at, tenant, tenant_root, visible_on_profile, is_deleted, creator_system, primary_language, max_score) SELECT ?, title,"
        ...
        + " creator_system, primary_language, max_score FROM rubric WHERE id = ?::uuid AND is_deleted = false";
