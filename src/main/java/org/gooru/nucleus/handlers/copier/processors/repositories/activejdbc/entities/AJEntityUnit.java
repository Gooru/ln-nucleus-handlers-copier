...
public class AJEntityUnit extends Model {
    ...
    public static final String COPY_CONTENT =
        "insert into content(id, course_id, unit_id, lesson_id, collection_id, title, creator_id, modifier_id, "
            ...
            + "copyright_owner, info, display_guide, accessibility, url) select gen_random_uuid(), c.course_id, "
            ...
            + "ct.copyright_owner, ct.info, ct.display_guide, ct.accessibility, ct.url from content ct inner join "
