...
public class AJEntityUnit extends Model {
  ...
  public static final String COPY_UNIT =
      "insert into unit(course_id, unit_id, title, owner_id, creator_id, modifier_id, original_creator_id, original_unit_id, parent_unit_id, big_ideas, essential_questions, metadata, taxonomy, sequence_id) select ?, ?, title, ?, ?, ?, coalesce(original_creator_id, creator_id) as original_creator_id, coalesce(original_unit_id, unit_id) as original_unit_id, unit_id, big_ideas, essential_questions, metadata, taxonomy, sequence_id from unit where unit_id = ? and is_deleted = false";
